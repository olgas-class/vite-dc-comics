...
<template>
    <section class="main-bg">
        <div class="container">
            ...
            <div class="comics-list flex-row justify-between">
                <!-- <ComicCard v-for="(comic, index) in comics" :key="index" :imgSrc="comic.thumb" :title="comic.series" /> -->
                <ComicCard v-for="(comic, index) in comics" :key="index" :comicObj="comic" />
            </div>
        </div>
    </section>
</template>
